...
using UpdateSourceTrigger = Windows.UI.Xaml.Data.UpdateSourceTrigger;

namespace CSharpMarkup.SystemXaml
{
    public static partial class Helpers
    {
        // Note that in contrast to WPF, WinUI 3 does not support bindings in a style setter; the corresponding .Bind() extension methods are not present in CSharpMarkup.SystemXaml
        // Source: https://docs.microsoft.com/en-us/windows/winui/api/Windows.UI.xaml.setter?view=winui-3.0#migration-notes
    ...
    /// <summary>
    /// Allows to specify <see cref="CSharpMarkup.SystemXaml"/> types (e.g. <see cref="TextBlock"/>) as well as commonly used built-in C# / UI types (e.g. <see cref="string"/> or <see cref="Xaml.Thickness"/>).
    /// </summary>
    ...
    public static partial class DependencyObjectExtensions
    {
        ...
        => property.SetBinding(new Windows.UI.Xaml.Data.Binding
        {
