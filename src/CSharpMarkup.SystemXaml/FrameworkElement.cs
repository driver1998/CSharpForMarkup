...
namespace CSharpMarkup.SystemXaml
{
    public static partial class Helpers
    {
        ...
        public static VisualStateGroup VisualStateGroup(string name, Xaml.VisualState[] states = null, Xaml.VisualTransition[] transitions = null)
        {
            ...
            return CSharpMarkup.SystemXaml.VisualStateGroup.StartChain(ui);
        }
...
#if NET7_0_ANDROID
        public static FrameworkElement Native(Android.Views.View view) => Windows.UI.Xaml.Media.VisualTreeHelper.AdaptNative(view);
#endif
    ...
    public static partial class FrameworkElementExtensions
    {
        public static TTarget OnDataContextChanged<TTarget, TUI, TContext>(this TTarget target, Action<TUI, TContext> onChanged)
            where TTarget : FrameworkElement where TUI : Windows.UI.Xaml.FrameworkElement
        {
