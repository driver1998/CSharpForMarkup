...
using AttachedPropertyTargetType = Windows.UI.Xaml.DependencyObject; // Attached properties can target Markup types as well as non-Markup types, which is why AttachedPropertyTargetType is used in both _UIViewNamespace_ and _MarkupNamespace_

namespace _UIViewNamespace_
{
    using DependencyProperty = Windows.UI.Xaml.DependencyProperty;
    using ContentControl = Windows.UI.Xaml.Controls.ContentControl;
    using LayoutControl = Windows.UI.Xaml.Controls.Panel;
    using InlinesControl = Windows.UI.Xaml.Documents.Span;

    using _ViewBaseTypeName_ = Windows.UI.Xaml.FrameworkElement;
...
namespace _MarkupNamespace_
{
    ...
    using _ViewBaseTypeName_ = CSharpMarkup.SystemXaml.FrameworkElement; // This is to get the template compiling; _ViewBaseTypeName_ is defined in the _UIViewNamespace_
...
#region TypeConvertorFromString
    ...
    public partial class _NonViewPropertyTarget_ : Windows.UI.Xaml.DependencyObject { }
